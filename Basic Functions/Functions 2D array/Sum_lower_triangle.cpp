...
void sum_lower_triangle(int[20][20],int,int);
...
void sum_lower_triangle(int a[20][20], int r, int c){
    int i,j,f; 
    f = 0;
    for(i = 0 ; i < r; i = i + 1){
        for(j = 0; j < c; j = j + 1){
    ...
    cout<<"sum of the lower triangle of the 2D array: "<<f;
